"""
Django settings for Full_Stack_Software project.
...
SECRET_KEY = env("SECRET_KEY", default="mDKvwTUzzsoPdfekCjZWiRWyyCPYLMjCeBymAwER")
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="configuration"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "configuration_language"
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="configuration-media")
...
EMAIL_SUBJECT_PREFIX = "[Full_Stack_Software] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Full_Stack_Software",
    "DESCRIPTION": "Create a modern web application with ease using Django & React.js Base Template. This powerful combo of Djangos backend and React.js frontend, offers a solid foundation for building feature-rich, responsive application, in rapid time.",
    "VERSION": "0.1.0",
...
WAGTAIL_SITE_NAME = "Full_Stack_Software Content"
WAGTAILADMIN_BASE_URL = "http://generic_domain.com"
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("Full_Stack_Software"),
    "URL": "http://generic_domain.com",
...
LOGGING = {
    ...
    "loggers": {
        ...
        "configuration": {
            "handlers": ["console"],
            "level": env("CONFIGURATION_LOG_LEVEL", default="INFO"),
        },
    },
}
