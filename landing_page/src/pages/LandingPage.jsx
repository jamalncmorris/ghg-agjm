...
import NeedLawyer from '../components/NeedLawyer'
...
const primaryFeatures = [
  {
    name: 'Find Clients',
    description:
      'Rapidly browse active legal cases and find clients looking for representation.',
    href: '#',
    icon: BoltIcon,
  },
  {
    name: 'Collaborate',
    description:
      'Manage and store case work securely, using our cloud storage services to transfer case files.',
    href: '#',
    icon: UsersIcon,
  },
  {
    name: 'Manage Case Work',
    description:
      'Assign and manage case work efficiently between teams and firms.',
    href: '#',
...
const secondaryFeatures = [
  {
    name: 'Secure.',
    description: 'Our platform is secure and compliant in the United Kingdom.',
    icon: CloudArrowUpIcon,
  },
  {
    name: 'Legal.',
    description: 'We cater to the needs of legal professionals with various expertise.',
    icon: LockClosedIcon,
  },
  {
    name: 'Intuitive.',
    description: 'User-friendly interface designed for legal professionals.',
    icon: ArrowPathIcon,
  },
  {
    name: 'Valuable.',
    description: 'Grow your practice turnover with our tools.',
    icon: FingerPrintIcon,
  },
  {
    name: 'Compliance.',
    description: 'We ensure compliance with legal standards and regulations.',
    icon: Cog6ToothIcon,
  },
  {
    name: 'Records.',
    description: 'Store and manage case records securely.',
    icon: ServerIcon,
  },
]
const stats = [
  { id: 1, name: 'Legal Professionals on the platform', value: '100+' },
  { id: 2, name: 'Average Daily submissions', value: '44' },
  { id: 3, name: 'Uptime guarantee', value: '99.9%' },
  { id: 4, name: 'Cases Handled', value: '1,000s' },
]
      ...
      <main>
          ...
          <div className="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-40">
            <div className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
              ...
              <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8 dark:text-gray-400">
                Our platform offers a valuable and effective method for growing your business. Browse live cases, Upload active cases, Find new clients and grow your practice with our intuitive tools and professional community. 
              </p>
        ...
        <div className="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
          <h2 className="text-center text-lg/8 font-semibold text-gray-900 dark:text-white">
            The UK's most innovative legal practices use our app
          </h2>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base/7 font-semibold text-indigo-600 dark:text-indigo-400">Find Cases</h2>
            <p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl lg:text-balance dark:text-white">
              Everything you need to grow your business
            </p>
            <p className="mt-6 text-lg/8 text-gray-600 dark:text-gray-300">
              You can find legal cases and connect with clients looking for representation. 
            </p>
          </div>
        ...
        <div className="mt-32 sm:mt-56">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              ...
              <p className="mt-6 text-lg/8 text-gray-600 dark:text-gray-300">
                Browse through open legal cases and find clients looking for legal representation across the UK.
              </p>
            </div>
          </div>
        ...
        <div className="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg/8 text-pretty text-gray-600 dark:text-gray-300">
              Get paid for the work you do by representing your clients.
            </p>
      ...
      <footer className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="border-t border-gray-200 py-12 md:flex md:items-center md:justify-between dark:border-white/10">
          ...
          <p className="mt-8 text-center text-sm/6 text-gray-600 md:order-1 md:mt-0 dark:text-gray-400">
            &copy; {currentYear} GGM Software. All rights reserved.
          </p>
        </div>
      </footer>
