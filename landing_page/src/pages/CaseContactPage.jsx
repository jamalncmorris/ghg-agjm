...
function PrivacyPolicyAcceptance() {
  return (
    <fieldset>
      <legend className="sr-only">Privacy Policy</legend>
      <div>      
        <div className="flex gap-3">
          ...
          <div className="text-sm/6">
            ...
            <span id="offers-description" className="text-gray-500 dark:text-gray-400">
              <span className="sr-only">Privacy Policy </span>our privacy policy.   
              {' '}
              <Link 
                to="/privacy-policy" 
                target="_blank" 
                rel="noopener noreferrer" 
                className='text-indigo-500 hover:text-indigo-600 hover:underline dark:text-indigo-400 dark:hover:text-indigo-300 dark:hover:underline'
...
export default function CaseContactPage() {
  useScrollToTop()
  return (
        ...
        <div className="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p className="mt-6 text-lg/8 text-gray-600 dark:text-gray-400">
              Please provide your details and we'll get back to you. GGM will find the best lawyer to represent your case. 
            </p>
