...
const navigation = [
  { name: 'Cases', href: '#', icon: FolderIcon, current: false },
  { name: 'Database', href: '#', icon: ServerIcon, current: false },
  { name: 'Activity', href: '#', icon: SignalIcon, current: false },
  { name: 'Browse', href: '#', icon: GlobeAltIcon, current: true },
  { name: 'Marketplace', href: '#', icon: ChartBarSquareIcon, current: false },
  { name: 'Settings', href: '#', icon: Cog6ToothIcon, current: false },
]
const teams = [
  { id: 1, name: 'AM Legal Service LTD', href: '#', initial: 'A', current: false },
  { id: 2, name: 'Embassy Lawyers Inc', href: '#', initial: 'E', current: false },
  { id: 3, name: 'Baxster Solicitors LTD', href: '#', initial: 'B', current: false },
]
const statuses = {
...
const deployments = [
  {
    id: 1,
    href: '#',
    projectName: 'Road Traffic Act 1988 (Section 5)',
    teamName: 'Bolton',
    status: 'online',
    statusText: 'Added 22m 00s ago',
  ...
  },
  {
    id: 2,
    href: '#',
    projectName: 'Theft Act 1968 (Section 1)',
    teamName: 'Liverpool',
    status: 'online',
    statusText: 'Added 33m 17s ago',
    description: 'Criminal',
    environment: 'Preview',
  },
  {
    id: 3,
    href: '#',
    projectName: 'Public Order Act 1986 (Section 5)',
    teamName: 'Manchester',
    status: 'offline',
    statusText: 'Added 44m 00s ago',
    description: 'Criminal',
    environment: 'Preview',
  },
  {
    id: 4,
    href: '#',
    projectName: 'Misuse of Drugs Act 1971 (Section 5)',
    teamName: 'Bolton',
    status: 'online',
    statusText: 'Added 44m 30s ago',
    description: 'Criminal',
    environment: 'Preview',
  },
  {
    id: 5,
    href: '#',
    projectName: 'Criminal Damage Act 1971 (Section 1)',
    teamName: 'Bolton',
    status: 'online',
    statusText: 'Added 44m 44s ago',
    description: 'Criminal',
    environment: 'Preview',
  },
  {
    id: 6,
    href: '#',
    projectName: 'Offences Against the Person Act 1861 (Section 47)',
    teamName: 'Wrexham',
    status: 'online',
    statusText: 'Added 120m 20s ago',
    description: 'Criminal',
    environment: 'Preview',
  },
  {
    id: 7,
    href: '#',
    projectName: 'Criminal Justice Act 1988 (Section 139)',
    teamName: 'Bristol',
    status: 'offline',
    statusText: 'Added 132m 00s ago',
    description: 'Criminal',
    environment: 'Preview',
  },
  {
    id: 8,
    href: '#',
    projectName: 'Fraud Act 2006 (Section 2)',
    teamName: 'Lewisham',
    status: 'offline',
    statusText: 'Added 2m 15s ago',
    description: 'Criminal',
    environment: 'Preview',
  },
]
                  ...
                  <ul role="list" className="flex flex-1 flex-col gap-y-7">
                    ...
                    <li className="-mx-6 mt-auto">
                      ...
                      >
                        ...
                        <span aria-hidden="true">Marcus Fordham</span>
                      </a>
                    </li>
                  </ul>
                </nav>
        ...
        <div className="xl:pl-72">
          ...
          <main className="lg:pr-96">
            <header className="flex items-center justify-between border-b border-gray-200 px-4 py-4 sm:px-6 sm:py-6 lg:px-8 dark:border-white/5">
              <h1 className="text-base/7 font-semibold text-gray-900 dark:text-white">Live Cases</h1>
          ...
          <aside className="bg-gray-50 lg:fixed lg:top-16 lg:right-0 lg:bottom-0 lg:w-96 lg:overflow-y-auto lg:border-l lg:border-gray-200 dark:bg-black/10 dark:lg:border-white/5">
            <header className="flex items-center justify-between border-b border-gray-200 px-4 py-4 sm:px-6 sm:py-6 lg:px-8 dark:border-white/5">
              <h2 className="text-base/7 font-semibold text-gray-900 dark:text-white">My Latest Cases</h2>
              ...
              {activityItems.map((item) => (
                <li key={item.commit} className="px-4 py-4 sm:px-6 lg:px-8">
                  ...
                  <p className="mt-3 truncate text-sm text-gray-500">
                    Acquired <span className="text-gray-700 dark:text-gray-400">{item.projectName}</span> (
                    <span className="font-mono text-gray-700 dark:text-gray-400">{item.commit}</span> with{' '}
