...
export default function NeedLawyer() {
  // useScrollToTop()
  const [openNeedLawyer, setOpenNeedLawyer] = useState(true)

  return (
    <div>
      {/* <button
        onClick={() => setOpenNeedLawyer(true)}
      ...
      <Dialog open={openNeedLawyer} onClose={setOpenNeedLawyer} className="relative z-10">
        <DialogBackdrop
          transition
            ...
            >
              <div>
                <div className="mx-auto flex size-12 items-center justify-center rounded-full bg-indigo-100 dark:bg-indigo-500/10">
                  <ScaleIcon aria-hidden="true" className="size-6 text-indigo-600 dark:text-indigo-400" />
                </div>
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-2">
                    <p className="text-sm font-bold text-gray-500 dark:text-gray-400">
                      Need legal representation? Get Started. 
                    </p>
                  </div>
                  <div className="mt-2">
                    <p className="text-sm text-gray-600 dark:text-gray-500">
                      Are you a lawyer? Join the Platform.
                    </p>
                  </div>
                </div>
              </div>
              <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                ...
                <button
                  type="button"
                  data-autofocus
                  onClick={() => setOpenNeedLawyer(false)}
